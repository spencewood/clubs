		...
		<>
			...
			<div className="min-h-screen bg-background pb-16">
				...
				<main className="container mx-auto px-4 py-6">
					{config && (
						<div className={`relative ${leftPanelView === "metrics" ? "" : "xl:flex xl:flex-row"} gap-8 items-start`}>
							{/* Left: Sites/Upstreams Panel - Elevated "table" (content height) */}
							<div className="space-y-4 bg-card border rounded-lg shadow-lg p-6 relative z-20 xl:z-10">
								{/* Tab Navigation */}
							...
							{leftPanelView !== "metrics" && (
							<div className="absolute inset-0 z-10 xl:relative xl:z-auto flex flex-col space-y-4 min-h-[calc(100vh-12rem)] opacity-60 hover:opacity-100 transition-opacity duration-200">
								{/* Tab Navigation */}
