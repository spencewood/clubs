...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
	...
	return (
		<style
			// biome-ignore lint/security/noDangerouslySetInnerHtml: This is safe - shadcn chart component generates CSS from config
	...
	(
		...
		return (
			<div
				ref={ref}
				className={cn(
					"flex flex-wrap items-center justify-center gap-x-4 gap-y-2 px-2",
